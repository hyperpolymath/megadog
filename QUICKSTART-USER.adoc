...
// Replace megadog, Megadog — See README.adoc for details., just run, Megadog started successfully. with actuals
= megadog — Quick Start for Users
:toc:
:toclevels: 2

== What is megadog?

Megadog — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./megadog-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/megadog/wiki
