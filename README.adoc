https://opensource.org/licenses/MPL-2.0[image:[MPL-2]]
https://github.com/hyperpolymath/palimpsest-license[image:[Palimpsest]]

*Ethical merge game with Mandelbrot dogtags - no scams, just maths.*

[!link:./MANIFESTO.md[RSR
Compliant]([https://img.shields.io/badge/RSR-Compliant-gold)](./MANIFESTO.md](https://img.shields.io/badge/RSR-Compliant-gold)])
...
`+ln(1,000,000,000)+` `+×+` `+10^6+` `+=+` `+20,723,266+` `+(int128:+`
`+16+` `+bytes)+``
