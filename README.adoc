...
:experimental:
:url-github: https://github.com/hyperpolymath/megadog
:url-gitlab: https://gitlab.com/hyperpolymath/megadog
:url-bitbucket: https://bitbucket.org/hyperpolymath/megadog
:url-codeberg: https://codeberg.org/hyperpolymath/megadog

Mega-scale dog-fooding automation
...
megadog is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
