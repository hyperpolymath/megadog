...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*Ethical merge game with Mandelbrot dogtags - no scams, just math.*")
...
(define development-practices
  '((code-style
     (languages . ("Dockerfile" "Just" "Kotlin" "Lean" "Nickel" "Nix" "Pony" "Scheme" "Shell" "Vyper"))
